...
with col1:
    ...
    for bar in bars_battery:
        ...
        ax.text(bar.get_x() + bar.get_width()/2, height / 2, f"{height:1.0f} Wh",
...
"""
    ...
    # Gráficos
    pdf.ln(3)
    pdf.image("temp_chart.png", x=10, y=165, w=90,h=75)
    pdf.image("temp_gauge.png", x=110, y=190, w=90, h=70)
