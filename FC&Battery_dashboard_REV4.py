...
st.markdown("""
    <div style="display: flex; align-items: center; gap: 10px;">
        <h2 style="margin: 8px; font-size: 3em;">🔋Camping Truck System Dashboard</h3>
        <img src="https://raw.githubusercontent.com/Victor1492Alvarez/Fuel_Cell-Battery_kpi-dashboard/main/dashboard_logo.png" width="160" style="margin-left: 16px;" />
    </div>
